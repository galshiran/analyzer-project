...
public class JavaOperations {
	 ...
	 **/
	public static void compileCode(Path fileCodeName, Path[] dependencyJars, Path outputFilePath) throws Exception {
	 ...
	 *             from the method execCommandWriteStreamToFile
	 **/
	public static void runProgram(Path fileCodeName, Path[] dependencyJars, Path outputFilePath) throws Exception {
	 ...
	 *             from the method execCommandWriteStreamToFile
	 **/
	public static void disassemblyCode(Path classNameWithPath, Path outputFilePath) throws Exception {
	 ...
	 * @throws Exception
	 **/
	public static void execCommandWriteStreamToFile(String command, Path outputFilePath) throws Exception {
